...
const data: Project[] = [
  {
    ...
    location: 'Colombia',
    title: 'Connecting the Atlantic Forest   wildlife corridors',
    objective: 100000,
    description:
...
const ProjectsScreen = (props: ProjectsScreenProps): JSX.Element => {
  ...
  return (
    <View className="bg-white flex-1">
      <FlatList
        ...
        data={data}
        renderItem={({ item }) => (
          <ProjectCell navigation={navigation} project={item} />
        )}
      />
    </View>
  );
