...
import PicassoImage from './PicassoImage';
...
const PerfectImage: React.FC<Props> = ({ url, style, resizeMode, className }) => {
	...
	if (!loaded) {
		return (
			<View className={className} style={style}>
				...
				<Image style={styles.hidden} onLoad={() => setLoaded(true)} source={{ uri: url }} />
			</View>
		);
	}
